...
class Solution {
    ...
    public void split(Node head1){
        ...
        Node temp1 = dummy1;
        Node temp2 = dummy2;
        Node temp = head1;  //Mergedd list pr traverse kar rha hai 
        while(temp!=null){
            temp1.next  = temp ;
            temp1 = temp1.next;
            temp = temp.next;
            ...
            temp1.next=null;   //first List ko torne ke liye
    }

    public Node copyRandomList(Node head1) {
        //Step 1 : Create Deep Copy without Random
        Node head2 = DeepCopy(head1);
        //Step 2 : ALternatively Connecting List
        mergelist(head1,head2);
        //Step 3 : Assining Random Pointer 
